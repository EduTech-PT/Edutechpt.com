            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
                <div className="relative flex-1 md:w-64">
                    <input 
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-white/50 border border-white/60 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none text-indigo-900 placeholder-indigo-400 font-medium"
                    />
