        ...
        <div className="space-y-6 animate-in fade-in">
            <div className="bg-indigo-50 p-6 rounded-xl border border-indigo-100 flex items-center gap-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-indigo-700 opacity-80">Completaste {completedCount} de {totalCount} materiais.</p>
                    ...
                    <div className="space-y-2">
                        {announcements.slice(0, 2).map(a => (
                            <div key={a.id} className="p-3 bg-white/60 border border-indigo-50 rounded-lg">
                                ...
                                <div className="text-sm text-indigo-900 font-bold">{a.title}</div>
                                <div className="text-xs text-indigo-700 opacity-80 line-clamp-1" dangerouslySetInnerHTML={{ __html: a.content.substring(0,100) }} />
                            </div>
                        ))}
                    </div>
                )}
