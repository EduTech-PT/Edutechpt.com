    ...
    return (
        <GlassCard className="flex items-center justify-between mb-4 py-3 shrink-0">
             <div className="flex gap-2">
                <button onClick={onPrev} className="p-2 hover:bg-indigo-50 rounded-full text-indigo-600 font-bold text-lg" title="Mês Anterior">◀</button>
                <button onClick={onNext} className="p-2 hover:bg-indigo-50 rounded-full text-indigo-600 font-bold text-lg" title="Próximo Mês">▶</button>
             </div>
