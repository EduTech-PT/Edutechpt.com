...
-- SCRIPT v1.1.32 - Avatar Strict Limits
...
-- Inserção de configurações com NOVOS LIMITES AVATAR
insert into public.app_config (key, value) values 
('sql_version', 'v1.1.32-installing'),
('avatar_resizer_link', 'https://www.iloveimg.com/resize-image'),
('avatar_help_text', E'Requisitos Rigorosos:\n1. Dimensões exatas: 100x100px.\n2. Formato: Quadrado (1:1).\n3. Tamanho máximo: 100KB.'),
...
-- Forçar atualização dos limites de avatar se já existirem com valores antigos
update public.app_config set value = '100' where key = 'avatar_max_size_kb';
insert into public.app_config (key, value) values ('avatar_max_width', '100') on conflict (key) do update set value = '100';
insert into public.app_config (key, value) values ('avatar_max_height', '100') on conflict (key) do update set value = '100';
...
update public.app_config set value = 'v1.1.32' where key = 'sql_version';
