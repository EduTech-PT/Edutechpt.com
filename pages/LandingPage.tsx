    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <nav className="w-full p-4 md:p-6 flex justify-between items-center z-20 sticky top-0 bg-white/10 backdrop-blur-md border-b border-white/20 transition-all duration-300">
        ...
        <div className="flex items-center gap-3 md:gap-6">
            <button onClick={scrollToCourses} className="hidden md:block text-indigo-800 font-bold hover:text-indigo-600 transition-colors text-sm">Cursos</button>
      ...
      <div className="flex-grow flex flex-col items-center justify-center text-center px-4 py-12 md:py-24 relative overflow-hidden">
        ...
        <GlassCard className="max-w-5xl z-10 w-full border-t-white/60 border-l-white/60">
          <span className="inline-block py-1 px-3 rounded-full bg-indigo-100 text-indigo-700 text-xs font-bold uppercase tracking-wider mb-6 border border-indigo-200">Formação Profissional</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button onClick={scrollToCourses} className="px-8 py-4 bg-white/60 text-indigo-900 border border-white rounded-xl font-bold text-lg hover:bg-white transition-all backdrop-blur-sm shadow-sm">Explorar Catálogo</button>
          </div>
        </GlassCard>
      </div>
      ...
      <div className="w-full bg-white/20 backdrop-blur-md border-y border-white/30 py-8 mb-16 relative z-10">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div className="flex flex-col items-center"><span className="text-3xl mb-2">🎓</span><span className="font-bold text-indigo-900 text-lg">Certificada</span><span className="text-xs text-indigo-600 uppercase tracking-wide">Formação</span></div>
              <div className="flex flex-col items-center"><span className="text-3xl mb-2">💻</span><span className="font-bold text-indigo-900 text-lg">100% Online</span><span className="text-xs text-indigo-600 uppercase tracking-wide">Flexibilidade</span></div>
              <div className="flex flex-col items-center"><span className="text-3xl mb-2">📚</span><span className="font-bold text-indigo-900 text-lg">{courses.length}+ Cursos</span><span className="text-xs text-indigo-600 uppercase tracking-wide">Disponíveis</span></div>
              <div className="flex flex-col items-center"><span className="text-3xl mb-2">🤝</span><span className="font-bold text-indigo-900 text-lg">Comunidade</span><span className="text-xs text-indigo-600 uppercase tracking-wide">Aprendizagem</span></div>
          </div>
      </div>
      ...
      <div id="courses-section" className="px-4 pb-20 max-w-7xl mx-auto w-full z-10 scroll-mt-24">
        <div className="text-center mb-12">
            ...
            <p className="text-indigo-600 max-w-2xl mx-auto">Explore a nossa seleção de cursos mais procurados.</p>
        </div>
                ...
                {courses.map(course => (
                    <GlassCard key={course.id} hoverEffect={true} className="flex flex-col h-full group p-0 overflow-hidden border-0 bg-white/40">
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                            ...
                            <button onClick={() => setSelectedCourse(course)} className="w-full py-3 bg-indigo-50 text-indigo-700 rounded-xl font-bold hover:bg-indigo-600 hover:text-white transition-all shadow-sm flex items-center justify-center gap-2 group-hover:shadow-md">
          ...
          <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <GlassCard className="text-center p-8 relative overflow-visible">
                      ...
                      <p className="text-indigo-700 text-sm leading-relaxed">Navegue pelo nosso catálogo e selecione a formação.</p>
                  </GlassCard>
                  <GlassCard className="text-center p-8 relative overflow-visible">
                      ...
                      <p className="text-indigo-700 text-sm leading-relaxed">Crie a sua conta de aluno para aceder à turma.</p>
                  </GlassCard>
                  <GlassCard className="text-center p-8 relative overflow-visible">
                      ...
                      <h3 className="mt-8 text-xl font-bold text-indigo-900 mb-3">Certifique-se</h3>
                      <p className="text-indigo-700 text-sm leading-relaxed">Realize avaliações e obtenha o certificado.</p>
                  </GlassCard>
              </div>
          </div>
      </div>
