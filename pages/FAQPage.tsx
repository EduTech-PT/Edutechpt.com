...
const DEFAULT_CONTENT = `
            ...
            <p class="lead text-center text-lg font-medium opacity-80 mb-12 text-indigo-700 dark:text-indigo-100">
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="p-5 flex justify-between items-center">
                                                    <h3 className={`font-bold text-lg transition-colors ${isOpen ? 'text-indigo-600 dark:text-indigo-300' : 'text-indigo-900 dark:text-white'}`}>
                                                        {item.q}
                                                    </h3>
                                                ...
                                                <div className={`px-5 overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-[1000px] pb-6 opacity-100' : 'max-h-0 opacity-0'}`}>
                                                    <div 
                                                        className="text-indigo-800 dark:text-indigo-100 text-sm leading-relaxed border-t border-indigo-50 dark:border-slate-700 pt-4 prose prose-indigo dark:prose-invert max-w-none dark:prose-p:text-indigo-100 dark:prose-li:text-indigo-100 dark:prose-strong:text-white"
